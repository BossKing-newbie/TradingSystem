<template>
  <div>
    <div class="header background-header">
          ...
          <div class="col-md-6">
            <div class="w3ls-header-right">
              ...
              <ul v-if="this.$root.userIsLogined == false">
                <li class="dropdown head-dpdn">
                  <el-button  type="primary" icon="edit" @click="showLogin" style="color:black"><i class="fa fa-user" aria-hidden="true"></i>登录</el-button>
                ...
                <li class="dropdown head-dpdn">
                  <el-button type="primary" icon="edit" @click="showRegister" style="color:black"><i class="fa fa-user" aria-hidden="true"></i>注册</el-button>
      ...
      <div class="header-two" style="height:600px; width:100%"><!-- header-two -->
        <el-row>
          <p class="header-p1"><span>技能在线</span></p>
          <p class="header-p2"><span>减少额外成本 增强服务效率</span></p>
        </el-row>
    ...
    <div class="header-two" style="height:600px; width:100%"><!-- header-two -->
      <el-row>
        <p class="header-p1"><span>需求求助</span></p>
        <p class="header-p2"><span>为你的需求找到匹配的达人服务</span></p>
      </el-row>
      <el-row>
        <el-col :span="6" :offset="1">
          <el-card style="height: 350px" shadow="hover">
            <img src="https://www.youbangxin.com/img/need1.952ceb26.png" class="image" style="width: 100%">
          </el-card>
        </el-col>
        <el-col :span="6" :offset="2">
          <el-card style="height: 500px" shadow="hover">
            <img src="https://www.youbangxin.com/img/need2.1dc2a916.png" class="image" style="width: 100%">
          </el-card>
        </el-col>
        <el-col :span="6" :offset="2">
          <el-card style="height: 320px" shadow="hover">
            <img src="https://www.youbangxin.com/img/need3.0f13ad23.png" class="image" style="width: 100%;display: block">
          </el-card>
        </el-col>
      </el-row>
    </div>
